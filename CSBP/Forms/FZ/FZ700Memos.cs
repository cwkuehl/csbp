...
namespace CSBP.Forms.FZ
{
  ...
  /// <summary>Controller für FZ700Memos Dialog.</summary>
...
#pragma warning disable 169, 649
    ...
    /// <summary>Label notizen0.</summary>
    [Builder.Object]
    private Label notizen0;

    /// <summary>TreeView notizen.</summary>
    [Builder.Object]
    private TreeView notizen;
...
#pragma warning restore 169, 649
    ...
    /// <param name="p">Betroffener Eltern-Dialog.</param>
    /// <returns>Nicht-modalen Dialogs.</returns>
    public FZ700Memos(Builder b, IntPtr h, Dialog d = null, DialogTypeEnum dt = DialogTypeEnum.Without, object p1 = null, CsbpBin p = null)
        : base(b, h, d, dt, p1, p)
    {
      ObservableEventThrottle(refreshAction, delegate { RefreshTreeView(notizen, 1); });
      // SetBold(client0);
      InitData(0);
      notizen.GrabFocus();
    }
    ...
    override protected void InitData(int step)
    {
      ...
      if (step <= 1)
      {
        ...
        foreach (var e in l)
        {
          // Nr.;Thema;Geändert am;Geändert von;Angelegt am;Angelegt von
          values.Add(new string[] { e.Uid, e.Thema,
    ...
    /// <summary>Behandlung von Notizen.</summary>
    /// <param name="sender">Betroffener Sender.</param>
    /// <param name="e">Betroffenes Ereignis.</param>
