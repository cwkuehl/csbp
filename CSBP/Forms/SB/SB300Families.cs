...
/// <summary>Controller for SB300Families dialog.</summary>
...
#pragma warning restore CS0649
  ...
  public SB300Families(Builder b, IntPtr h, Dialog d = null, Type type = null, DialogTypeEnum dt = DialogTypeEnum.Without, object p1 = null, CsbpBin p = null)
      : base(b, h, d, type ?? typeof(SB300Families), dt, p1, p)
  {
    // SetBold(client0);
    InitData(0);
    familien.GrabFocus();
