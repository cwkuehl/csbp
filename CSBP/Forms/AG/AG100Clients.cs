...
#pragma warning restore CS0649
  ...
  /// <summary>Initializes a new instance of the <see cref="AG100Clients"/> class.</summary>
  ...
  public AG100Clients(Builder b, IntPtr h, Dialog d = null, Type type = null, DialogTypeEnum dt = DialogTypeEnum.Without, object p1 = null, CsbpBin p = null)
      : base(b, h, d, type ?? typeof(AG100Clients), dt, p1, p)
  {
    // SetBold(client0);
    InitData(0);
  }
  ...
  /// <summary>Handles Mandanten.</summary>
  /// <param name="sender">Affected sender.</param>
  /// <param name="e">Affected event.</param>
