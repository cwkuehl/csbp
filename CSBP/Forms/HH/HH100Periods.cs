...
#pragma warning restore CS0649
  ...
  public HH100Periods(Builder b, IntPtr h, Dialog d = null, Type type = null, DialogTypeEnum dt = DialogTypeEnum.Without, object p1 = null, CsbpBin p = null)
      : base(b, h, d, type ?? typeof(HH100Periods), dt, p1, p)
  {
    // SetBold(client0);
    InitData(0);
    perioden.GrabFocus();
