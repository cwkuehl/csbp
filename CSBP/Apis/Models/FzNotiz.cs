...
namespace CSBP.Apis.Models
{
  ...
  /// <summary>
  /// Entity-Klasse für Tabelle FZ_Notiz.
  /// </summary>
  [Serializable]
  [Table("FZ_Notiz")]
  public partial class FzNotiz : ModelBase
  {
    /// <summary>Initialisiert eine neue Instanz der <see cref="FzNotiz"/> Klasse.</summary>
    public FzNotiz()
    {
    ...
    /// <summary>Holt oder setzt den Wert der Spalte Thema.</summary>
