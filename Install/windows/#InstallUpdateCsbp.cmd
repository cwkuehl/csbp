:: Installation and update for program CSBP (c) 2023 cwkuehl.de
@echo off
...
echo %mydate% %time% Installation and update for program CSBP (c) 2023 cwkuehl.de >> Log.txt
...
echo :: Start program CSBP (c) 2023 cwkuehl.de > #Csbp0.cmd
