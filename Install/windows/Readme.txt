...
2) Nur fuer Windows 7, weil Powershell zu alt ist: Es muss curl.zip von https://curl.se/download.html heruntergeladen werden. Die Datei curl.exe muss in das Verzeichnis kopiert werden.
3) Speichern der Batch-Datei als #InstallUpdateCsbp.cmd in einem leeren Verzeichnis, z.B. D:\Haushalt\CSBP.
3) Starten von cmd.exe.
4) Wechseln in das Verzeichnis:
 D:
 cd \Haushalt\CSBP
