= CSBP Dokumentation (C) 2022 cwkuehl.de
...
----
#! /bin/bash
# Start program CSBP (c) 2022 cwkuehl.de
...
.11+|Privat      |                    |Aufruf der Funktionen und Dialoge aus dem Bereich Privat.
...
|==========================
////
                 |TODO Sudoku              |Dieses Formular erlaubt das Prüfen und Lösen von Sudoku-Rätseln. <<SO100>>
////
