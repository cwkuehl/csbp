...
|Suche        |Suchfeld für alle Textfelder in Person, Sitz und Adresse. Die Liste wird schon aktualisiert, wenn man aufhört einzugeben.
|Name         |Suchfeld für den Namen. Die Liste wird schon aktualisiert, wenn man aufhört einzugeben.
|Vorname      |Suchfeld für den Vornamen. Die Liste wird schon aktualisiert, wenn man aufhört einzugeben.
