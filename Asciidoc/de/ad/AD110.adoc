...
|Geschlecht   |Geschlecht der Person. Neutrum auch für Firmen oder sonstige Dinge.
...
|# gleiche Adresse|Anzahl der Personen bzw. Sitze, die die gleiche Adresse verwenden.
