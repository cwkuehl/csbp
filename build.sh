...
# ==> OK
dotnet publish ~/cs/csbp/CSBP/CSBP.csproj -c Release -f net5.0 -r ubuntu-x64 --self-contained false -p:Version=1.0.0.0
#dotnet publish ~/cs/csbp/CSBP/CSBP.csproj -c Release -f net6.0 -r ubuntu-x64 --self-contained true -p:Version=1.0.0.0
#dotnet publish ~/cs/csbp/CSBP/CSBP.csproj --configuration Release --framework net5.0 --runtime win-x64 -p:Version=1.0.0.0
