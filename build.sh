...
dotnet publish ~/cs/csbp/CSBP/CSBP.csproj -c Release -f net10.0 -r linux-arm64 --self-contained false
#linux-x64 --self-contained false
#thirdlicense --project ./CSBP/CSBP.csproj
#cd Asciidoc
#./asciidoc-csbp.sh
#cd ..

cp -rf /home/wolfgang/cs/csbp/CSBP/bin/Release/net10.0/linux-arm64/publish/ /opt/Haushalt/CSBP/
#linux-x64/publish/ /opt/Haushalt/CSBP/
