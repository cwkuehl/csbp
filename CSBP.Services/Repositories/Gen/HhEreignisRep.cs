...
/// <summary>
/// Generated repository base class for table HH_Ereignis.
/// </summary>
...
#pragma warning disable CA1822
  ...
  /// <param name="etext">Value of column EText.</param>
  ...
  public HhEreignis Save(ServiceDaten daten, int mandantnr, string uid, string kz, string sollkontouid, string habenkontouid, string bezeichnung, string etext, string angelegtvon = null, DateTime? angelegtam = null, string geaendertvon = null, DateTime? geaendertam = null)
  {
    ...
    if (a != null && a.TableName != "HH_Ereignis")
      e = Clone(daten, a);
  ...
  public HhEreignis Clone(ServiceDaten daten, HhEreignis e)
  {
    if (e != null && e.TableName != "HH_Ereignis")
    {
      var db = GetDb(daten);
      db.Entry(e).State = Microsoft.EntityFrameworkCore.EntityState.Detached;
      var a = new HhEreignis
      {
        Mandant_Nr = e.Mandant_Nr,
        Uid = e.Uid,
        Kz = e.Kz,
        Soll_Konto_Uid = e.Soll_Konto_Uid,
        Haben_Konto_Uid = e.Haben_Konto_Uid,
